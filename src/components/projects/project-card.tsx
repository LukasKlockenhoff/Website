...
import LogoMeetAndAsk from "@/assets/logo-meetandask.png";
import textstyles from "@/utils/textstyles";
    ...
    return (
        <div className="group relative bg-white dark:bg-background md:rounded-3xl w-[430px] h-[298px] p-8 sm:p-0">
            ...
            <div className={"relative flex w-full justify-between"}>
                <Image
                    alt="Ellipse"
                    src={slug === "meetandask" ? LogoMeetAndAsk : LandingPageImage}
                    width={100}
                    height={100}
            ...
            <div className={"relative flex flex-col w-[90%] pt-2"}>
                <div className={twMerge(textstyles.H3, "underline-offset-2 hover:underline")}><Link href={`https://${title}`}>{title}</Link></div>
                <div
                    className={twMerge(
                        Textstyles.SmallText,
