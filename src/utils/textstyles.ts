const TextStyles = {
  ...
  H1Gradient: "font-inter font-black text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl leading-tighter text-transparent tracking-tight",
  ...
  H2Gradient: "font-inter font-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl leading-tighter text-transparent tracking-tight",
