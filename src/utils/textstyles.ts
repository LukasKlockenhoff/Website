const TextStyles = {
  H1: "font-sans font-black text-9xl leading-tighter dark:text-white text-black tracking-tight",
  H1Gradient: "font-sans font-black text-9xl leading-tighter text-transparent tracking-tight",
  H2: "font-inter font-black text-8xl leading-tighter dark:text-white text-black tracking-tight",
  H2Gradient: "font-inter font-black text-8xl leading-tighter text-transparent tracking-tight",
  H3: "font-inter font-black text-6xl leading-tighter dark:text-white text-black tracking-tight",
  H4: "font-inter text-4xl leading-tighter dark:text-white text-black tracking-tight",
  ...
  BigHint: "font-inter text-[1.0625rem]  text-grey",
