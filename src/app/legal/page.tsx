      ...
      >
        ...
        >
          <div>
            ...
            >
              <div>Lukas Klockenhoff</div>
              <div>Bredower Straße 16</div>
              <div>14612 Falkensee</div>
              <div className={twMerge(textstyles.SmallText, "mt-3")}>
                Contact E-Mail: l@lukaskl.com
              </div>
            </div>
            <div
          ...
          <div className={"mt-12 ml-8"}>
            <ReadMoreLink link={"https://www.e-recht24.de"} title={"Source"} />
          </div>
        </div>
      </div>
    </div>
