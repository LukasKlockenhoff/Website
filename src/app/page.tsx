...
export default function Home() {
    return (
        <div className={"w-full h-full bg-background"}>
            <div
                className={"flex flex-col w-[80%] sm:w-full mx-auto gap-y-4 sm:ml-24 pt-14 sm:pt-24 overflow-hidden"}
            >
                <Image
                ...
                >
                    <h1 className={twMerge("flex font-michroma text-2xl sm:text-4xl text-white")}>
